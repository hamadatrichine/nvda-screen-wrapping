...
addon_info = {
	...
	If elements are not found below your position, you will be placed at the first element of the requested type available from the beginning of tghe page and virseversa when you are searching upwards."""),
	# version
	"addon_version" : "1.5",
	# Author(s)
